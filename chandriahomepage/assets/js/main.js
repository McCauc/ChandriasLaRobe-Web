...
const tabs = document.querySelectorAll('[data-target]'),
  ...
  /*================================== PLACE ORDER ========================= */
  // Removed the line that sets the button text to 'Appointment Successful' and submits the form
  // The actual rental placement and validation should be handled in checkout.js
