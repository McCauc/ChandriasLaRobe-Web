...
$(document).ready(function () {
    ...
    // Removed automatic redirection to test_Profile.html
    onAuthStateChanged(auth, user => {
        if (user && !isLoggingIn) {
            console.log("User is logged in:", user.email); // Log user info instead of redirecting
        } else {
    ...
    loginBtn.on("click", async function (e) {
        ...
        try {
            ...
            // Updated redirection after successful login
            setTimeout(() => {
