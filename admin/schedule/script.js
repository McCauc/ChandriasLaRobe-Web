document.addEventListener("DOMContentLoaded", () => {
    ...
    const tbody = document.getElementById("appointment-body"); // Ensure tbody is selected

    // Add console logs to debug the click event and data attributes
    tbody.addEventListener('click', function(e) {
        if (e.target.classList.contains('view-product-btn')) {
            ...
            modalProductImage.src = productImage || '/admin/images/wings.png'; // Fallback image
            productViewModal.style.display = 'flex'; // Use 'flex' for centering
        }
    });
